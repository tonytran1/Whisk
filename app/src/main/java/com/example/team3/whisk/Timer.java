 ...
 *
 *      This class provides the timer activity.
 *
 *      The timer activity provides the user with the ability to change color schemes, ring tone,
 *      and setting a timer for clocking. The timer is persistent throughout the application.
 *
 *      @author Team 3
 *      @version 1.00
 */
...
public class Timer extends AppCompatActivity
    ...
    public class CounterClass extends CountDownTimer{
        ...
        public void onFinish(){
            ...
            NotificationCompat.Builder notification= new NotificationCompat.Builder(Timer.this)
            ...
            notiIntent.setClass(myContext, Timer.class);
        ...
        public void onTick(long millisUntilFinished){
            ...
            //***Setting up Notification
            NotificationCompat.Builder notiStatus= new NotificationCompat.Builder(Timer.this)
                    .setTicker(hms)
                    .setSmallIcon(R.drawable.hourglass)
    ...
    private void showUserSettings() {
        ...
        switch (favTone){
            ...
            case "musicbox":
                playClip = MediaPlayer.create(Timer.this,R.raw.musicbox);
                break;
            case "prelude":
                playClip = MediaPlayer.create(Timer.this,R.raw.prelude);
                break;
            case "loudalarm":
                playClip = MediaPlayer.create(Timer.this,R.raw.loudalarm);
                break;
            case "tornadosiren":
                playClip = MediaPlayer.create(Timer.this,R.raw.tornadosiren);
                break;
            default:
                playClip = MediaPlayer.create(Timer.this,R.raw.loudalarm);
        }
