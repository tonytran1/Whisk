...
/**     File name: SavedIngredientsList.java
 *
 *      This class contains the activity for viewing and inputting saved ingredients.
 *
 *      The saved ingredients will then be allowed to be used with the home activity.
 *
 *      @author Team 3
 *      @version 1.00
 */

public class SavedIngredientsList extends AppCompatActivity
    ...
    /**     This method allows the user to save ingredients.
     *
    ...
    /**     This method updates the list of saved ingredients in case a new ingredient is added.
     *
     */
    public void updateListView() {
        ...
        try {
            ...
            if (c.getCount() == 0){
                ...
                Toast.makeText(SavedIngredientsList.this, "Save some Ingredients!", Toast.LENGTH_LONG).show();
            }
            int ingredientNameIndex = c.getColumnIndex("ingredientName");
